    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (log){
            case 1:
                ...
                buttonReg.setBackgroundColor(getResources().getColor(R.color.buttonmainfive, null));
                break;
            case 2:
                relativeLayout.setBackgroundResource(R.drawable.wallspaperlogregtwo);
                buttonReg.setBackgroundColor(getResources().getColor(R.color.buttonmaintwo, null));
                break;
            case 3:
                relativeLayout.setBackgroundResource(R.drawable.wallspaperlogregthree);
                buttonReg.setBackgroundColor(getResources().getColor(R.color.buttonmainthree, null));
                break;
            case 4:
                relativeLayout.setBackgroundResource(R.drawable.wallspaperlogregfour);
                buttonReg.setBackgroundColor(getResources().getColor(R.color.buttonmainfour, null));
                break;
