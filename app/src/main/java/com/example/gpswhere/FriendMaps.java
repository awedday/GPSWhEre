...
public class FriendMaps extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(id == R.id.nav_signOut){
                    ...
                    if(user !=null) {
                        ...
                        Intent intent = new Intent(FriendMaps.this, MainActivity.class);
                ...
                {
                    Intent myIntent = new Intent(FriendMaps.this,JoinCircleActivity.class);
...
//                    });
                ...
                {
                    Intent myIntent = new Intent(FriendMaps.this,MyCircleActivity.class);
                    startActivity(myIntent);
                    finish();
                }
